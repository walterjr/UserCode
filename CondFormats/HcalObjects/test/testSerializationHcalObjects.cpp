...
int main()
{
    ...
    */
    ...
    testSerialization<std::pair<std::string, std::vector<HcalQIETyp>>>();
    ...
    testSerialization<std::vector<HcalQIETyp>>();
    ...
    testSerialization<std::vector<std::pair<std::string, std::vector<HcalQIETyp>>>>();
