...
//  const HcalQIETyp* getHcalQIETyp (const HcalGenericDetId& fId) const;
...
//  void setData (const HcalQIEType* fItem) {mQIEType = fItem; mCalibSet = nullptr; }
